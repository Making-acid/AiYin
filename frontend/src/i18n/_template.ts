...
const template: Record<string, string> = {
  ...
  ttsPreviewHaru: "Preview Haru", ttsPreviewMao: "Preview Mao", ttsSaved: "Voice configuration saved.",
  ttsSaveFailed: "Could not save voice configuration.", ttsPreviewFailed: "Voice preview failed.",
