; -*- mode: pascal -*-
; IELTS Speaking Beta 1.1.1 -- Windows Installer
; Build: ISCC.exe setup.iss
; Requires: ..\IELTS-Speaking-WebView2-Beta-1.1.1-Release\AppStage\

#define MyAppName "IELTS Speaking"
#define MyAppVersion "1.1.1-beta.1"
#define MyAppDisplayVersion "Beta 1.1.1"
...
#define MyReleaseRoot "..\IELTS-Speaking-WebView2-Beta-1.1.1-Release"
...
OutputBaseFilename=IELTS-Speaking-WebView2-Beta-1.1.1-Setup
